const Banner = ({ name, childStyles, parentStyle, theme }) => (
  <div className={`relative w-full flex items-center z-0 overflow-hidden  ${theme === 'dark' ? 'nft-gradient' : 'nft-gradient-2'} ${parentStyle}`}>
